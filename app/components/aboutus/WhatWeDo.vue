<template>
    <div class="mr-[85px] ml-[85px] pt-20">
        ...
        <WhatWeDoProps title="What We Do" description="We turn that mission into action by developing smart, digital queue management
            solutions that make waiting efficient, organized, and effortless empowering people and
             businesses alike." />

        <WhatWeDoProps title="Our Mission" description="At QUEWIE, our mission is simple yet powerful to redefine waiting through smart,
            seamless, and human-centered technology.
            We aim to empower people and businesses by making queue management faster, fairer,
            and more efficient.
            Through innovation, we strive to turn every waiting experience into an opportunity for
            convenience, productivity, and satisfaction. " />

        <WhatWeDoProps title="Our Vision" description="We envision a world were waiting no longer feels wasted.
            A world where technology connects people and services effortlessly,
            where every line moves with purpose, and every moment counts.
...
import WhatWeDoProps from './WhatWeDoProps.vue';
